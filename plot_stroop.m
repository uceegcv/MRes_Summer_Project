...
% one_participant = Av30mm(2,:,:);
% one_par = squeeze(one_participant);
...
figure(1);
DOTHUB_plotHRF30(tHRF,newAv30mm,SEM_30mm,30)
%saveas(gcf,'NonReg_30mm_stroop.png');
...
figure(2);
DOTHUB_plotHRF20(tHRF,newAv20mm,SEM_20mm,30)
%saveas(gcf,'NonReg_20mm_stroop.png');
...
figure(3);
DOTHUB_plotHRF10(tHRF,newAv10mm,SEM_10mm,30)
%saveas(gcf,'NonReg_10mm_stroop.png');
...
figure(1);
DOTHUB_plotHRF30(tHRF,newAv30mm_reg,SEM_30mm_reg,30)
%saveas(gcf,'Reg_30mm_stroop.png');
...
figure(2);
DOTHUB_plotHRF20(tHRF,newAv20mm_reg,SEM_20mm_reg,30)
%saveas(gcf,'Reg_20mm_stroop.png');
...
figure(3);
DOTHUB_plotHRF10(tHRF,newAv10mm_reg,SEM_10mm_reg,30)
%saveas(gcf,'Reg_10mm_stroop.png');
...
%saveas(gcf,'Ded_30mm_stroop.png');
...
%saveas(gcf,'Ded_20mm_stroop.png');
...
%saveas(gcf,'Ded_10mm_stroop.png');
